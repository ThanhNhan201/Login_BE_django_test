"""
Django settings for nettruyen project.
...
SECRET_KEY = 'django-insecure-%d$hsfq10mf8j%^3ot^4^^*9mwesy)o=54-8w37z8c*idt4r4g'
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'vietdev-nettruyen.onrender.com']
